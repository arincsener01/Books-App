// No need for this controller either, it's just a wrapper for the Role class, and it's not used anywhere in the project
...
namespace MVC.Controllers
{
    public class RolesController : MvcController
    {
        ...
        public IActionResult Create(RolesModel role)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public IActionResult Edit(RolesModel role)
        {
            if (ModelState.IsValid)
            {
